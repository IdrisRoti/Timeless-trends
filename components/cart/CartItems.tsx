            ...
            <div key={i} className="mb-9">
              <article className="flex items-center py-3 px-2">
                ...
                <div className="mr-2 md:mr-14">
                  ...
                  <h2 className="text-sm md:text-base font-bold mb-2.5 md:mb-5">
                    {cartItem.name}
                  </h2>
                ...
                <div className={`${isCart && "flex items-center flex-col lg:flex-row gap-4 lg:gap-0 ml-8 lg:ml-0"}`}>
                  ...
                  {/* product price */}
                  <div className="ml-4 lg:ml-[6.5rem] text-sm lg:text-base font-semibold md:text-base">
                    $58.90
                  </div>
                </div>

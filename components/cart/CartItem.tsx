    ...
    <div className="mb-9">
      <article className="flex items-center py-3 px-2">
        ...
        <div className="mr-2 md:mr-14">
          ...
          <button onClick={()=> removeFromCart(cartItem.id)} className="text-[#E21A1A] md:text-base text-sm hover:opacity-80 transition duration-500">
            Remove
          </button>
        </div>
        <div
        ...
        >
          ...
          <div className={`gap-2 ${isCart ? "flex" : "hidden"} items-center`}>
            ...
            <div onClick={()=> decreaseQty(cartItem.id)} className="w-6 h-6 cursor-pointer border rounded-full p-1 hover:border-black/80 transition duration-500">
              <Image
                src={"/minus.png"}
                alt="increase button"
                width={24}
            ...
            <div onClick={()=> increaseQty(cartItem.id)} className="w-6 h-6  cursor-pointer hover:opacity-70 border rounded-full p-1 hover:border-black/80 transition duration-500">
              <Image
                src={"/plus.png"}
                alt="decrease button"
                width={24}
